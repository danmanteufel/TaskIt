...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // MARK: - Core Data stack - NOW SET UP IN THE MODELMANAGER.SWIFT file
    
//    lazy var applicationDocumentsDirectory: NSURL = {
//        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.mandevilprogramming.TaskIt" in the application's documents Application Support directory.
...
//        let modelURL = NSBundle.mainBundle().URLForResource("TaskItModel", withExtension: "momd")! //MAKE SURE THIS MATCHES IF YOU ADD CORE DATA MANUALLY AFTER CODE IS STARTED!!!!
